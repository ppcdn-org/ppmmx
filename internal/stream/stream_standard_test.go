...
func TestStreamReaderFilter(t *testing.T) {
	desc := &description.Session{Medias: []*description.Media{
		{
			Type:    description.MediaTypeVideo,
			Formats: []format.Format{&format.H264{PacketizationMode: 1}},
	...
	subStream := &SubStream{Stream: strm, UseRTPPackets: false}
	...
	r.OnDataFiltered(
		desc.Medias[0],
		desc.Medias[0].Formats[0],
		func(u *unit.Unit) bool { return u.PTS >= 2 },
